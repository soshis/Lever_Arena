...
# Arena params
v_positions = [0.00110, 0.00130]
h_positions = [0.00130, 0.00135]

threshold = np.array([2400,2500,2600,2700,2800,2900,3000,3100,3200])
# threshold = np.array([2800,2900,3000,3100,3200])

max_threshold = threshold[-1]
errors = 0 # number of too weak pushed  on the lever
ITI_time = 2     # Inter Trials Interval
inc_thr = 5 #number of success beofre increasing the threshold
